...
class Company_info {
    ...
    function get_company_addressbranch() {
        return $this->get_info->addressbranch;
    }
    ...
    function get_company_whatsappbranch() {
        return $this->get_info->whatsappbranch;
    }
