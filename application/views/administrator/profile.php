            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="file" name="userfile" accept="image/png, image/jpg, image/jpeg" class="dropify" data-default-file="<?= base_url(); ?>img/<?= $dataAdmin->photo; ?>" value="<?= $this->company_info->get_company_logo(); ?>" />
                    </div>
                    <div class="form-group">
                        <label>Nama</label>
