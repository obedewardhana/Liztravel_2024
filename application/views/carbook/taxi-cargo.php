      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="<?php echo base_url('');?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Taxi & Cargo <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Taxi & Cargo</h1>
          </div>
        </div>
      </div>
    </section>
...
<section class="ftco-section bg-white pt-5" id="car-section">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="mb-3 text-center">Armada kami</h2>
		...
		<section class="ftco-section ftco-intro" style="background-image: url('<?php echo base_url();?>/img/tesbaru.png'); background-size:cover;">
			<div class="overlay"></div>
			<div class="container">
				<div class="row justify-content-end">
					<div class="col-md-6 heading-section heading-section-white ftco-animate">
            <h2 class="mb-3">Taxi mahal minggir dulu, disini cepat & terjangkau.</h2>
            <a href="https://wa.me/<?= $this->company_info->get_company_whatsapp();?>" class="btn btn-primary btn-lg">Pesan langsung</a>
          </div>
				</div>
			</div>
		</section>
