      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="<?php echo base_url('');?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Tempat Wisata <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Tempat Wisata</h1>
          </div>
        </div>
      </div>
    </section>
...
<section class="ftco-section bg-white pt-5" id="car-section">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h2 class="mb-3 text-center">Trip yang tersedia.</h2>
